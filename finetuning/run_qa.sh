...
#PBS -m be
#PBS -e /grand/projects/SolarWindowsADSP/alanyahya/run_qa.sh_e.sh
#PBS -o /grand/projects/SolarWindowsADSP/alanyahya/run_qa.sh_o.sh
...
deepspeed \
    ...
    /grand/projects/SolarWindowsADSP/alanyahya/run_qa.py \
        --model_name_or_path Flamenco43/NanoBERT-customvocab-final \
        --run_name NanoBERT-V2-qa-SQUAD \
        ...
        --output_dir /grand/projects/SolarWindowsADSP/alanyahya/models/NanoBERT-V2-QA \
