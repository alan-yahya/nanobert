...
#PBS -m be
#PBS -e /grand/projects/SolarWindowsADSP/alanyahya/run_ner_e.sh
#PBS -o /grand/projects/SolarWindowsADSP/alanyahya/run_ner_o.sh
...
#        --dataset_name batterydata/cner \

deepspeed \
    --hostfile="${DS_HOSTFILE}" \
    /grand/projects/SolarWindowsADSP/alanyahya/run_ner3.py \
        ...
        --output_dir /grand/projects/SolarWindowsADSP/alanyahya/models/run_ner_base \
        --run_name run_ner_base \
        --push_to_hub \
